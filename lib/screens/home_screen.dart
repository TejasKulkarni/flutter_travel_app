...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: Container(
          ...
          child: ListView(
            children: <Widget>[
              ...
              buildSmoothPageIndictor(),
              buildPopularCategories(),
              buildCategoryTabs(),
              buildCategoryImageCarousel()
            ],
          ),
        ),
      ),
  ...
  Container buildCategoryImageCarousel() {
    return Container(
      height: 124.8,
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(beaches[i].image),
              ),
            ),
          );
        },
  ...
  Padding buildPopularCategories() {
    return Padding(
  ...
  Padding buildSmoothPageIndictor() {
    return Padding(
  ...
  Container buildImageCarousel(BuildContext context) {
    return Container(
      height: 218.4,
          ...
          (int index) => GestureDetector(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (ctx) => SelectedPlaceScreen(
